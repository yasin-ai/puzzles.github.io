// Boxes By JOhn555 Github (https://github.com/john555/picture-puzzle)
...
!(function (t, e) {
    ...
    (function (t) {
        ...
        function (t, e, n) {
            ...
            var i = 150,
                r = { x: "y", y: "x" },
                o = { 37: "right", 38: "bottom", 39: "left", 40: "top", 83: "top", 87: "bottom", 65: "right", 68: "left" },
                a = { TOP: "TOP", RIGHT: "RIGHT", BOTTOM: "BOTTOM", LEFT: "LEFT", NONE: "NONE" },
                c = ["width", "height"];
        },
        function (t, e, n) {
            "use strict";
        ...
        function (t, e, n) {
            ...
            function r(t, e, n) {
                var r = t.options,
                    o = "translate("
                        .concat(n.x * r.tileSize, "px, ")
                        .concat(n.y * r.tileSize, "px) scale(")
                        .concat(r.scale, ")"),
                    a = "translate("
                        .concat(e.x * r.tileSize, "px, ")
                        .concat(e.y * r.tileSize, "px) scale(")
                        .concat(r.scale, ")");
                Object(i.a)(e.tileElement, { transform: o }), Object(i.a)(n.tileElement, { transform: a });
                var c = e.x,
                    u = e.y,
                    l = e.order;
        ...
        function (t, e, n) {
            "use strict";
            n.r(e);
            var i = { tileSize: 120, rows: 4, columns: 4, difficulty: 4, scale: 0.996, image: { preserve: "width", offset: 0 } },
                r = n(0),
                o = n(1);
            var a = n(2);
            var c = n(4);
            function u(t, e) {
                ...
                if (l) {
                    ...
                    !(function (t, e, n) {
                        var i = e[0];
                        if (i)
                            if (i.isEmpty) for (var r = 1; r < e.length; r++) Object(a.a)(t, i, e[r]);
                            else {
                                var o = e[e.length - 1];
                                if (o) for (var c = e.length - 1; c >= 0; c--) Object(a.a)(t, o, e[c]);
                            }
                    })(
                        t,
                        (function (t, e, n, i, o) {
                                    ...
                                    l = setInterval(function () {
                                        ...
                                        for (var t = 0; t < e.length; t++) {
                                            var r = e[t],
                                                ...
                                                p = "".concat(d, " ").concat(v);
                                            Object(o.a)(r.tileElement, { transform: p });
                                        }
                                        i--;
                                    }, r.b);
                            })(t);
            ...
            function d(t, e) {
                e.tileElement.addEventListener(
                    "click",
                    (function (t, e) {
                        return function () {
                            t.isPlaying && u(t, e);
                    ...
                    e.tileElement.addEventListener("transitionend", l(t)),
                    e.tileElement.addEventListener(
                        "touchstart",
                        (function (t, e) {
                            return function (n) {
                                t.touchDetails = { touch: n.touches[0], tile: e };
                            };
                        })(t, e)
                    ),
                    e.tileElement.addEventListener(
                    ...
                    e.tileElement.addEventListener(
                        ...
                        (function (t) {
                            return function (e) {
                                t.touchDetails = { touch: null, tile: null, objectiveCompleted: !1 };
                            };
                        })(t)
                    );
            }
            ...
            function p(t, e) {
                ...
                if (((t.tiles = []), (t.isPlaying = !1), (t.time = 0), (t.touchDetails = { touch: null, tile: null, objectiveCompleted: !1 }), e.image.preserve && r.e.indexOf(e.image.preserve) < 0))
                    throw new Error("Invalid value '".concat(e.image.preserve, "' for the option image.preserve"));
                var n = Object.assign({}, i.image, e.image);
                return (
                    (t.options = Object.assign({}, i, e)),
                    (t.options.image = n),
                    (t.stage = (function (t) {
                        var e = t.options,
                            n = document.createElement("div");
                        return Object(o.a)(n, { position: "relative", width: "".concat(e.tileSize * e.columns, "px"), height: "".concat(e.tileSize * e.rows, "px") }), n;
                    })(t)),
                    (function (t) {
                        for (var e = t.options, n = t.tiles, i = 0, a = 0; a < e.rows; a++)
                            for (var c = 0; c < e.columns; c++) {
                                var u = document.createElement("div"),
                                    ...
                                    v = "",
                                    p = "";
                                "width" === e.image.preserve && ((v = "".concat(e.columns * e.tileSize, "px auto")), (p = "-".concat(l, "px -").concat(s - e.image.offset, "px"))),
                                    "height" === e.image.preserve && ((v = "auto ".concat(e.rows * e.tileSize, "px")), (p = "-".concat(l - e.image.offset, "px -").concat(s, "px"))),
                                    Object(o.a)(u, {
                                    ...
                                    f || Object(o.a)(u, { backgroundImage: "url(".concat(e.image.url, ")"), backgroundRepeat: "no-repeat", backgroundPosition: p, backgroundSize: v, zIndex: 2 });
                                var h = { x: c, y: a, order: i, isEmpty: f, tileElement: u };
                                d(t, h), n.push(h), i++;
                            }
                    })(t),
                    (function (t) {
                        var e = t.tiles,
                            n = t.stage;
                        if (!(e.length < 0)) for (var i = 0; i < e.length; i++) n.appendChild(e[i].tileElement);
                    })(t),
                    Object(v.a)(t),
                    t.stage
                );
            ...
            function y(t, e) {
                ...
                var r,
                    o,
                    u = ((r = i), (o = Math.floor(Math.random() * r.length)) === r.length && (o -= 1), r[o]);
            ...
            (b.prototype.render = function (t) {
                    ...
                    return this.isPlaying
                        ...
                        : this.shuffle().then(function () {
                              (t.isPlaying = !0),
                                  ...
                                  t.stage.dispatchEvent(new Event("start"));
                          });
                }),
                ...
                (b.prototype.shuffle = function () {
                    ...
                    return new Promise(function (n) {
                        var i,
                            r = Math.floor(Math.abs(e.difficulty * e.rows * e.columns)),
